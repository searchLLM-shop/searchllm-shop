...
// Haiku, deliberately: generating shopper keywords is an easy task, and the
// manual enrichment button should cost as little as possible when it is
// used (it is off by default — see ENABLE_AI_KEYWORDS). Current per-token
// pricing: https://docs.claude.com/en/api/overview
