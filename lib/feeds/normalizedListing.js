...
const CATEGORY_KEYWORDS = {
  ...
  // Health/nutrition/supplements — common among vCommission D2C brands
  // (e.g. TruNativ). Kept distinct from beauty since intent differs.
  health: ["nutrition", "supplement", "wellness", "health", "vitamin", "protein", "fitness", "ayurved"],
  // Broad ecommerce/marketplace offers (Shopsy, Flipkart, Amazon-style).
  // Falls here only if nothing more specific matched, since it's last.
