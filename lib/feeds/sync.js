...
export async function runFullSync() {
  ...
  // Each network fetches the external IDs it already has so the adapter
  // skips them and advances through a large catalog across runs, instead
  // of re-importing the same first N products every time.
  const results = [];
