...
Registered users: you can register with your email address or your mobile number as your sign-in method, and registration also collects your first name, last name, mobile number and email address — all four, regardless of which one you used to sign in — plus a daily count of how many searches you have run. Authentication is handled by our identity provider, including sending any verification code to confirm you own the email or mobile number you registered with; we never see or store your password.
Your first name, last name, mobile number and email are collected solely to administer your account and the rewards programme described in section 6A — most importantly, to have the identity details a gift voucher legally requires already on file before you ever try to redeem one (section 6AC). They are not used for marketing, not shared with any advertiser, affiliate partner or brand, and not used for any purpose outside this platform. You can review or update them at any time in your account profile.
...
1A. REGISTRATION
You may register using either your email address or your mobile number as your sign-in method. Whichever you choose, registration requires all of the following: first name, last name, mobile number and email address. This is deliberate, not incidental — these are the exact details a gift voucher requires under Reserve Bank of India rules (see 6BC), so they are collected once at registration rather than requested piecemeal later. They are used only to administer your account and the rewards programme on this platform (see the Privacy Policy, section 3) — never for any external or marketing purpose. You can review or update them at any time through your account profile; they are not editable from the redemption screen itself (see 6BC).
...
Redeeming points for a gift voucher requires five details: first name, last name, mobile number, email address and postal address — a requirement of Reserve Bank of India rules for the issuance of gift vouchers in India, not a policy we have discretion over. Your name, mobile and email are the ones on your account (collected at registration, section 1A) and are shown, locked, exactly as they read on your account at the moment you redeem — you cannot edit them on the redemption screen; to change them, update your account profile, which will then apply to any future redemption. Your postal address is not collected at registration and must be provided, and reconfirmed, at the time of every redemption, even when it is unchanged from last time. Providing inaccurate details — in your account profile or in the address you confirm — is your responsibility: we are not liable for a voucher misdelivered or misissued because the information on file or confirmed was wrong. See the Privacy Policy for how this information is stored and used.
