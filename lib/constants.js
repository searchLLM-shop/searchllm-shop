...
export const LOYALTY = {
  ...
  // --- Search points (marketing spend: NOT self-funding — capped hard) ---
  ...
  // Registered users: small per-pick credit under a daily cap, because
  // uncapped search points at ₹1/point would let a heavy user mint more
  // voucher value monthly than the annual Plus fee. Tune here, one place.
  SEARCH_POINTS: {
    GUEST_PER_PICK: 10,      // shown as "expiring today" — converts on signup
    USER_PER_PICK: 5,
    USER_DAILY_CAP: 15,      // max search points a registered user earns/day
  },
