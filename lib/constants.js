...
// AND the Increase-Usage design that preceded it). No membership tier, no
// purchase involvement anywhere: points come from search and click
// activity only, and the entire monetisation is one flat fee paid per
// 250-point block.
//
// Why no purchases: never honestly verifiable at scale. Only Awin's
// conversion feed is confirmed working; vCommission's conversions endpoint
// was never verified; Amazon Associates has no self-serve conversion API
// at all. Rather than gate anything on a signal we usually don't have yet
// when the decision needs to be made, purchases play no role in rewards.
//
