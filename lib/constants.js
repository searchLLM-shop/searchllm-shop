...
6AB. ADVERTISING MEASUREMENT
When we run advertising campaigns, we use industry-standard tag tooling (Google Tag Manager) to measure whether our own ads led to visits and sign-ups — for example a Meta (Facebook/Instagram) pixel that tells Meta "this ad click resulted in a visit". This measures OUR campaigns; it is not used to build profiles of your browsing on other websites, and we do not load cross-site remarketing or third-party advertising audiences. Tags of this kind may set cookies from the respective provider; you can block them with standard browser controls without affecting the service.
