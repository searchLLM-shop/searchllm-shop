...
Every research pick runs paid AI computation, and every recommended-product link consumes real infrastructure. Usage therefore works in cycles for all plans: a cycle's allowance is 50 picks and 25 recommended-product link clicks on the free plan, and 200 picks and 100 link clicks on Plus. When either allowance is reached without a completed purchase through our links, further picks and further recommended-product links are paused until you either complete a purchase we can reconcile with our partner networks or make an Increase Usage payment at the price shown in the product (currently ₹249) — each of which restarts your cycle in full. These checks recur throughout your use of the service. We may invite feedback at these points and we genuinely read it, but feedback does not extend usage.
To keep these limits meaningful, usage is also monitored per network address in privacy-preserving hashed form (see the Privacy Policy). Creating multiple accounts, rotating identities, or otherwise circumventing usage limits is prohibited; limits may be enforced at the network level, and circumvention may lead to suspension without refund. Network-level limits do not apply to any account that has completed a purchase or an Increase Usage payment. Increase Usage payments buy research and browsing capacity only: they are not refundable once consumed, carry no cash value, and do not affect points, vouchers, or plan status.
