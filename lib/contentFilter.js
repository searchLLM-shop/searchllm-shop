...
const RESTRICTED_CATEGORIES = [
  {
    ...
    terms: [
      ...
      // NOT blocked, by decision (2026-07-22): antiseptic liquids/creams
      // (Dettol/Savlon), ointments, and mouthwash — household hygiene and
      // first aid, not medicines. Internal medicines and pain-relief drug
      // brands (Volini/Moov/Iodex/Vicks) stay blocked as licensed OTC drugs.
      "ors", "homeopathic medicine", "ayurvedic medicine",
...
export function checkQuery(queryText) {
  ...
  for (const word of PROFANITY) {
    if (containsTerm(q, word)) {
      return { blocked: true, reason: "Please rephrase your question without profanity." };
    }
  }
