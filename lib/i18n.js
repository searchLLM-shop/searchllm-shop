...
const STRINGS = {
  en: {
    ...
    subtitle: "One clear, researched answer for every shopping question — and points every time you ask.",
  ...
  de: {
    ...
    subtitle: "Eine klare, recherchierte Antwort auf jede Einkaufsfrage — und Punkte bei jeder Anfrage.",
