...
const STRINGS = {
  en: {
    // Consent gate
    tagline1: "We tell you what to buy honestly",
    never1: "Never to disregard your query",
    tagline2: "We get paid only if you shop",
    never2: "Never for showing you something",
    tagline3: "We give rewards on the way",
    never3: "Never is loyalty compromised",
    subtitle: "An AI shopping answer engine. What we recommend is never limited to the brands that pay us.",
    ...
    acceptBothPre: "I accept the ",
    acceptBothMid: " and the ",
    acceptBothPost: ".",
    ...
    // Pre-research clarifying question (iterative: shown on every round,
    // not just the last one — see components/ResearchTab.jsx's clarify loop)
    clarifyHeading: "One quick question first",
    clarifyCustomPlaceholder: "or type your own answer…",
    clarifyContinue: "Continue",
    skipJustSearch: "Skip — just search",
  ...
  de: {
    // Consent gate
    tagline1: "Wir sagen dir ehrlich, was du kaufen sollst",
    never1: "Nie an deiner Frage vorbei",
    tagline2: "Wir verdienen nur, wenn du einkaufst",
    never2: "Nie dafür, dir etwas zu zeigen",
    tagline3: "Wir geben Belohnungen unterwegs",
    never3: "Nie zulasten der Ehrlichkeit",
    subtitle: "Eine KI-Antwortmaschine fürs Einkaufen. Unsere Empfehlungen sind nie auf die Marken beschränkt, die uns bezahlen.",
    ...
    acceptBothPre: "Ich akzeptiere die ",
    acceptBothMid: " und die ",
    acceptBothPost: ".",
    ...
    // Pre-research clarifying question (iterative: shown on every round)
    clarifyHeading: "Nur noch eine kurze Frage",
    clarifyCustomPlaceholder: "oder eigene Antwort eingeben…",
    clarifyContinue: "Weiter",
    skipJustSearch: "Überspringen — einfach suchen",
