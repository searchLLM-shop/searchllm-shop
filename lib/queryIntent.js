...
Respond with ONLY valid JSON, no markdown fences:
{
  ...
  "webQuery": "one natural search-engine query that would surface current prices and reviews for this need"
}
  ...
  try {
    ...
    return {
      ...
      retrievalTerms: Array.isArray(parsed.retrievalTerms)
        ...
        : [],
      webQuery: typeof parsed.webQuery === "string" && parsed.webQuery.trim() ? parsed.webQuery.trim() : null,
    };
  } catch (err) {
