...
const VARS = [
  ...
  "VCOMMISSION_CAMPAIGN_IDS",
  "VCOMMISSION_PUB_ID",
  "VCOMMISSION_CLICK_BASE",
  "MIN_PRODUCT_PRICE",
  "RAZORPAY_KEY_ID",
  "RAZORPAY_KEY_SECRET",
  ...
  "QWIKCILVER_LIVE",
  "QWIKCILVER_CLIENT_ID",
  "QWIKCILVER_CLIENT_SECRET",
  "QWIKCILVER_USERNAME",
  "QWIKCILVER_PASSWORD",
  "QWIKCILVER_BILLING_NAME",
  "QWIKCILVER_BILLING_LASTNAME",
  "QWIKCILVER_BILLING_EMAIL",
  "QWIKCILVER_BILLING_PHONE",
  "QWIKCILVER_BILLING_LINE1",
  "QWIKCILVER_BILLING_LINE2",
  "QWIKCILVER_BILLING_CITY",
  "QWIKCILVER_BILLING_REGION",
  "QWIKCILVER_BILLING_POSTCODE",
];
